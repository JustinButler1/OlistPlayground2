...
import { type CommunityFeedItem, type CommunityFeedMedia } from '@/data/mock-community-feed';
  ...
  return (
    ...
    >
      ...
      <View style={styles.cardContent}>
        <View style={styles.cardHeader}>
          <View style={styles.identityGroup}>
            <LinearGradient colors={item.avatarGradient} style={styles.avatar}>
              <ThemedText style={styles.avatarText}>{buildInitials(item.author)}</ThemedText>
            </LinearGradient>
            <View style={styles.identityCopy}>
              <ThemedText style={styles.authorName}>{item.author}</ThemedText>
              <ThemedText selectable style={[styles.metaText, { color: colors.icon }]}>
        ...
        {item.title ? <ThemedText style={styles.titleText}>{item.title}</ThemedText> : null}
