...
- Create a dedicated `testflight` EAS profile using `channel: "preview"` and App Store distribution; keep `preview` for internal installs and `production` for store-ready builds.
